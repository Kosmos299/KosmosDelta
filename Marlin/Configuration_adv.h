 ...
 *
 */
#define CONFIGURATION_ADV_H_VERSION 020106
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      860  // (mm) The length of filament for a complete unload.
